...
# Input (SRR037795, SRR037796, SRR037884, SRR037885)
...
# Run MACS2 on BAM files:
ctrl="Input.bam"; for file in H3*bam; do echo $file && macs2 -t $file -c $ctrl -n ../macs_out/${file/.bam/} -g 1.35e+08 -m 3,50 --bdg > ../macs_out/${file/.bam/_log.txt} 2>&1; done
# Compress Bedgraph files generated by MACS2:
for file in *bdg; do echo $file && gzip $file; done
